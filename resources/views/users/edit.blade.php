    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="/user">Tables</a>
                </li>
            </ul>
            <form class="d-flex">
...
<div class="main">
    ...
    <div class="cards" style="margin-top:2%">
        <form action="/admin/update/{{$user->userid}}" method="post" style="border:1px solid gray;width: 500px;"  enctype="multipart/form-data" >
            @csrf
            @method("PUT")
